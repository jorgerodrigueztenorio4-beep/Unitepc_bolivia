<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RR_HH_Datos_docentes_fac.aspx.vb" Inherits="RR_HH_Datos_docentes_fac" MasterPageFile="~/mp_rr_hh.master" %>
    	...
    	<div class="row">
                            ...
                            <div class="col-md-12 p-3 mb-2 bg-white text-white  rounded ">
                              <div style="background-color:#FFFACD" class="text-md-center  rounded text-bold " role="alert">
                               Lista de Docentes Contrato de FACTURACION
                            </div>
                                <asp:GridView ID="gv_fac" CssClass ="table-hover mt-1 " runat="server" AutoGenerateColumns="False" DataSourceID="sql_ds_fac" Font-Size="9pt">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="extension" HeaderText="Ext" SortExpression="extension" />
                                        ...
                                        <asp:BoundField DataField="carga_mensual" HeaderText="Carga Horaria Mensual" ReadOnly="True" SortExpression="carga_mensual" />
                                    </Columns>
...
where tco.tipoContrato ='facturacion' and td.comun is null"></asp:SqlDataSource>
                                </div>
            </div>
         </div>
          </form>
