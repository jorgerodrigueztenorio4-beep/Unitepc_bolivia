<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DIR_CAR_horarios_presenciales.aspx.vb" Inherits="DIR_CAR_horarios_presenciales" MasterPageFile="~/mp_dir_car.master" %>
                               ...
                               Lista de Horarios Presenciales
                                ...
                                <asp:GridView ID="gv_horarios_v" CssClass="table table-hover mt-1 " runat="server" AutoGenerateColumns="False" DataSourceID="sql_virtuales" Font-Size="9pt">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Sis_plan" HeaderText="Sis_plan" SortExpression="Sis_plan"></asp:BoundField>
                                    </Columns>
...
where th.tipo_clase ='presencial' and p.codcar =@carrera and th.sede =@sede" DeleteCommand="delete tb_horario where id_horario =@id_hor">
                                    <DeleteParameters>
