<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DIR_ACD_SEDE_cargas_horarias.aspx.vb" Inherits="DIR_ACD_SEDE_cargas_horarias" MasterPageFile="mp_dir_academico_sedes.master" %>
...
where h.gestion ='2-2022' and h.ci_doc =@ci and pe.gestion ='2-2022'">
         ...
         <asp:TextBox ID="txt_ci_us" runat="server"></asp:TextBox>
         </form>
</asp:Content>
