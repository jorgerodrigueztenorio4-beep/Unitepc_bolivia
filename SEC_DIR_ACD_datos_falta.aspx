<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SEC_DIR_ACD_datos_falta.aspx.vb" Inherits="SEC_DIR_ACD_datos_falta" MasterPageFile="mp_sec_dir_academico.master" %>
    ...
    <asp:Label ID="lbl_cargo"  runat="server" Text=""></asp:Label>
     ...
     <div class=" container-fluid ">
        ...
        <asp:TextBox ID="txt_vacio" runat="server" Visible="False"></asp:TextBox>
                                <asp:DropDownList ID="ddl_sede" runat="server" AutoPostBack="True" DataSourceID="sedes" DataTextField="NombreSede" DataValueField="idSede"></asp:DropDownList>
                                <asp:SqlDataSource ID="sedes" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" SelectCommand="SELECT * FROM [tb_sedes]"></asp:SqlDataSource>
