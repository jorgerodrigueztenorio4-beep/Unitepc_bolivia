<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DIR_ACD_datos_docente2.aspx.vb" Inherits="DIR_ACD_datos_docente2" MasterPageFile="~/mp_dir_academico.master" %>
...
where nombres like '%'+@buscar+'%' or primerApellido like '%'+@buscar+'%' or segundoApellido  like '%'+@buscar+'%' order by docente">
                                         <SelectParameters>
