<%@ Page Language="VB" AutoEventWireup="false" CodeFile="COORDINADOR_editar_grupos.aspx.vb" Inherits="COORDINADOR_editar_grupos" MasterPageFile="mp_coordinadores.master" %>
                              ...
                              <div style="background-color:#FFCC00" class="text-md-center  rounded text-bold " role="alert">
                               Lista de Horarios
                                 ...
                                 <div class="input-group mb-1">
                                     ...
                                     <asp:SqlDataSource ID="sql_ds_carrera" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" SelectCommand="SELECT id_carrera, CARSIGLA, CARDES, FACULTAD FROM tb_carreras WHERE (CARSIGLA = @sigla)">
                                         <SelectParameters>
                                             <asp:ControlParameter ControlID="txt_siglacar" Name="sigla" PropertyName="Text" />
                                         </SelectParameters>
                                     </asp:SqlDataSource>
