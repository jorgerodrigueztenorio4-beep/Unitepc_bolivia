...
Partial Class DIR_CAR_subir_clases
    ...
    Protected Sub gv_datos_SelectedIndexChanged(sender As Object, e As EventArgs) Handles gv_datos.SelectedIndexChanged
        ...
        txt_hrainicioO.Text = gv_datos.SelectedRow.Cells(9).Text
        txt_hrafinO.Text = gv_datos.SelectedRow.Cells(10).Text
    ...
    Protected Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        'txt_hrainicioO.Text = txt_fecha_marcado.Text + " " + ddl_horain.SelectedValue.ToString + ":" + ddl_minutosin.SelectedValue.ToString
        'txt_hrafinO.Text = txt_fecha_marcado.Text + " " + ddl_horasal.SelectedValue.ToString + ":" + ddl_minsal.SelectedValue.ToString
