<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ADM_BLO_reg_ingreso.aspx.vb" Inherits="ADM_BLO_reg_ingreso" MasterPageFile="mp_adm_blo.master" %>
     ...
     <div class=" container-fluid">
    	<div class="row">
                       ...
                       <h3></h3>Ingrese Su Nro de C.I.
                                ...
                                <asp:Label ID="lbl_ip" CssClass ="form-control mt-1" runat="server" BackColor="#BAB1C2" Font-Bold="True" Font-Size="14pt"></asp:Label>
                                ...
                                <asp:GridView ID="GridView1"  runat="server" CssClass ="table table-hover mt-1 " AutoGenerateColumns="False" DataSourceID="sql_ds_horario"  Font-Size="9pt">
                                    <Columns>
                                        <asp:CommandField ShowSelectButton="True" ButtonType="Button" SelectText="Seleccionar" ControlStyle-CssClass ="btn btn-primary mt-1 " />
                                        <asp:BoundField DataField="id_horario" HeaderText="id_horario" SortExpression="Id." InsertVisible="False" ReadOnly="True"/>
...
where tp.ci =@ci
and th.gestion='2-2022' and tp.gestion='2-2022' and td.horas &gt;'0'
...
" ProviderName="<%$ ConnectionStrings:unitepc_boliviaConnectionString.ProviderName %>">
               ...
               <div class="col-md-4 p-3 mb-1 text-black border border-dark rounded text-center ">
                   ...
                   <asp:Label ID="lbl_materia" runat="server" Text=""></asp:Label><br />
                   <asp:Label ID="lbl_dia" runat="server" Text=""></asp:Label><br />
                   <asp:Label ID="lbl_hi" runat="server" Text=""></asp:Label><br />
                   <asp:Label ID="lbl_hf" runat="server" Text=""></asp:Label><br />
                   <asp:TextBox ID="txt_id_horario2" runat="server"></asp:TextBox>
    ...
    <asp:GridView ID="gv_horario2" runat="server" AutoGenerateColumns="False" DataSourceID="sql_ds_horario2" Font-Size="9pt">
        <Columns>
 ...
 WHERE 
(th.ci_doc =@ci) AND (th.gestion = '2-2022') AND (th.sede = '1') and tp.gestion='2-2022'
...
WHERE tb_horario .id_horario = @id_hor and tb_ing_sal.id_ing_sal =@id_ingsal  and convert(time,getdate() )&gt;tb_horario.hora_fin" ProviderName="<%$ ConnectionStrings:unitepc_boliviaConnectionString.ProviderName %>">
                            ...
                            <asp:SqlDataSource ID="sql_ing_sal" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" InsertCommand="INSERT INTO tb_ing_sal(ci_doc, hr_ingreso, Materia, carrera, sede, id_horario, aula_o_lab, bloque, sigla_materia, ip_marcado) VALUES (@ci, GETDATE(), @materia, @carrera, '1', @idhorario, @aula, @bloque, @siglamat, @ip)" ProviderName="<%$ ConnectionStrings:unitepc_boliviaConnectionString.ProviderName %>" SelectCommand="select * from [tb_ing_sal]
...
">
                            ...
                            <asp:SqlDataSource ID="sql_ing_sal0" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" InsertCommand="INSERT INTO tb_ing_sal(ci_doc, hr_ingreso, Materia, carrera, sede, id_horario, aula_o_lab, bloque, sigla_materia, ip_marcado) VALUES (@ci, @horaingreso, @materia, @carrera, '1', @idhorario, @aula, @bloque, @siglamat, @ip)" ProviderName="<%$ ConnectionStrings:unitepc_boliviaConnectionString.ProviderName %>" SelectCommand="select * from [tb_ing_sal]
where ci_doc =@ci and hr_salida is null
">
                                <InsertParameters>
                                    <asp:ControlParameter ControlID="txt_ci" Name="ci" PropertyName="Text" />
