<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DIR_ACD_programar_horario.aspx.vb" Inherits="DIR_ACD_programar_horario" MasterPageFile="~/mp_dir_academico.master" %>
...
<asp:Content ID="Content1" runat="server" contentplaceholderid="ContentPlaceHolder1">
    	...
    	<div class="row">
                            ...
                            <div class="col-md-4 p-3 mb-2 bg-white text-white border border-dark rounded ">
                              <div style="background-color:#ffc107" class="text-md-center  rounded text-bold " role="alert">
                                ...
                                <asp:SqlDataSource runat="server" ID="sql_ds_aula" ConnectionString='<%$ ConnectionStrings:unitepc_boliviaConnectionString %>' SelectCommand="SELECT id_nomal , (nom_aula_lab +' -- Cap: '+capacidad +'-- Cap.B.S.: '+capacidad_bs) as aula   FROM [tb_aula] where bloque=@bloque  and gestion ='2-2022'  order by nom_aula_lab" ProviderName="<%$ ConnectionStrings:unitepc_boliviaConnectionString.ProviderName %>">
                                    <SelectParameters>
                                ...
                                <asp:DropDownList ID="ddl_carrera" CssClass="form-control btn btn-default border-dark  dropdown-toggle mt-1" runat="server" DataSourceID="sql_ds_carrera" DataTextField="CARDES" DataValueField="CARSIGLA" AppendDataBoundItems="True">
                                  ...
                                  <div style="background-color: 	#ffc107" class="text-md-center  rounded text-bold" role="alert">
                                Seleccione la Hora  y Minutos de Inicio de la Clase
                            </div>
                           <asp:DropDownList ID="ddl_dia" CssClass="form-control btn btn-default border-dark  dropdown-toggle mt-1" runat="server" AutoPostBack="True">
                            ...
                            <asp:DropDownList ID="ddl_hr_ini" CssClass="form-control  btn btn-outline-default border-dark mt-1 " runat="server" Visible="true">
                    <asp:ListItem>Hora de Inicio</asp:ListItem>
                    ...
                    <asp:ListItem>23</asp:ListItem>
                                            ...
                                            <asp:DropDownList ID="ddl_min_ini" CssClass ="form-control  btn btn-default border-dark mt-1" runat="server" Visible="true" AutoPostBack="True">
                    <asp:ListItem>Minutos de Inicio</asp:ListItem>
                    ...
                    <asp:ListItem>59</asp:ListItem>
                                ...
                                <div class="input-group mb-1">
                                  <asp:DropDownList ID="ddl_hra_fin" CssClass ="form-control btn btn-default  border-dark"  runat="server">
                  <asp:ListItem>Hora de Fin</asp:ListItem>
                     <asp:ListItem>06</asp:ListItem>
                    <asp:ListItem>07</asp:ListItem>
                    <asp:ListItem>08</asp:ListItem>
                    <asp:ListItem>09</asp:ListItem>
                ...
                <asp:DropDownList ID="ddl_min_fin" CssClass ="form-control btn btn-default  border-dark "  runat="server" AutoPostBack="True">
                    <asp:ListItem> Minutos de Fin</asp:ListItem>
                    <asp:ListItem>00</asp:ListItem>
                    <asp:ListItem>01</asp:ListItem>
                    <asp:ListItem>02</asp:ListItem>
                    <asp:ListItem>03</asp:ListItem>
    ...
    <%--Tipo de Clase--%>
                                ...
                                <div class="input-group mb-1">
                                  <asp:DropDownList ID="ddl_grupo" CssClass=" form-control btn btn-default border-dark  dropdown-toggle mt-1"  runat="server" AutoPostBack="True">
                     <asp:ListItem>Grupo Numerico</asp:ListItem>
                           ...
                           <asp:DropDownList ID="ddl_grupol" CssClass=" form-control btn btn-default border-dark  dropdown-toggle mt-1"  runat="server" AutoPostBack="True">
                 ...
                 <asp:TextBox ID="txt_grupos" CssClass ="form-control mt-1" runat="server" Visible="true"></asp:TextBox>
                                ...
                                Programar Clase
                                            ...
                                            <asp:GridView ID="gv_clases" CssClass="table table-hover mt-1 " runat="server" AutoGenerateColumns="False" DataSourceID="sql_ds_clase_no">
                                                <Columns>
                                               ...
                                               <asp:SqlDataSource ID="sql_ds_clase_no" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" SelectCommand="select th.id_horario ,th.dia ,th.tipo_clase,th.hora_inicio,th.hora_fin ,s.NombreSede ,b.nom_bloque , a.nom_aula_lab   from tb_horario th
join tb_aula a on th.aula = a.id_nomal 
join tb_bloques b on th.bloque = b.id_bloque
join tb_sedes s on th.sede = s.idSede  
where  designado='No' and th.gestion ='2-2022'"></asp:SqlDataSource>
                  ...
                  <asp:GridView ID="gv_prog" runat="server" AutoGenerateColumns="False" DataSourceID="sql_ocupado" Font-Size="9pt">
                      <Columns>
                          ...
                          <asp:BoundField DataField="carrera" HeaderText="carrera" SortExpression="carrera" ReadOnly="True" />
                                               ...
                                               <asp:SqlDataSource ID="sql_ocupado" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" SelectCommand="SELECT h.hora_inicio, h.hora_fin, h.dia, b.nom_bloque, a.nom_aula_lab, p.nombres + p.primerApellido + p.segundoApellido AS docente, isnull (d.carrera,'' ) as carrera FROM tb_horario AS h INNER JOIN tb_designacion AS d ON h.id_horario = d.id_horario INNER JOIN tb_personal AS p ON h.ci_doc = p.ci INNER JOIN tb_bloques AS b ON h.bloque = b.id_bloque INNER JOIN tb_aula AS a ON h.aula = a.id_nomal WHERE (h.sede = @sede) AND (h.bloque = @bloque) AND (h.dia = @dia) AND (h.aula = @aula) AND (h.hora_inicio &gt;= @hora_in) AND (h.hora_inicio &lt;= @horafin)">
                                                   <SelectParameters>
                                                       <asp:ControlParameter ControlID="ddl_sede" Name="sede" PropertyName="SelectedValue" />
                                                       <asp:ControlParameter ControlID="ddl_bloque" Name="bloque" PropertyName="SelectedValue" />
