...
Partial Class seguimiento_cochabamba
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If gv_horaingresaantes.Rows(0).Cells(0).Text < GridView1.Rows(0).Cells(16).Text Then
            ...
            'txt_ci.Text = gv_horario2.Rows(0).Cells(1).Text
    ...
    Protected Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        ElseIf GridView1.Rows.Count <= 0 And GridView2.Rows.Count <= 0 Then
            ClientScript.RegisterStartupScript(Me.GetType(), "mensaje", "<script>swal({title:""SEGUIMIENTO DOCENTE UNITEPC"", text:""No se encontro clases asignadas a esta hora para su persona, por favor revise su horario en la opcion (Horario del Docente) ubicado en el menu, lado izquierdo de la pantalla "", type: ""warning"" ,timer:15000}, function(){window.location.href = ""seguimiento_cochabamba.aspx"";});</script>")
        End If
