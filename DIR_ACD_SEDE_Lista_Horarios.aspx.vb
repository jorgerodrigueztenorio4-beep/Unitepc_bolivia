...
Partial Class DIR_ACD_SEDE_Lista_Horarios
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If gv_selec.Rows.Count >= 1 Then
            ...
            txt_hora.Text = ""
            ClientScript.RegisterStartupScript(Me.GetType(), "mensaje", "<script>swal({title:""UNITEPC Horarios"", text:""Se Modifico la Hora del Registro Seleccionado"", type: ""success"" });</script>")
        End If
    End Sub
