<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DOCENTE_datos_docente.aspx.vb" Inherits="DOCENTE_datos_docente" MasterPageFile="~/mp_docentes.master" %>
    	...
    	<div class="row">
                            ...
                            <div class="col-md-12 p-3 mb-2 bg-white text-white border border-dark rounded ">
                              <div style="background-color:#FFFACD" class="text-md-center  rounded text-bold " role="alert">
                                ...
                                <asp:SqlDataSource ID="sql_ds_docente" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" SelectCommand="SELECT * FROM [tb_personal] where ci=@cidoc and gestion='2-2022'" UpdateCommand="UPDATE tb_personal SET nombres = @nombres, primerApellido = @primerApellido, segundoApellido = @segundoApellido, email = @email, fechaNacimiento = @fechaNacimiento, estadoCivil = @estadoCivil, direccion = @direccion, telefono = @telefono, celular = @celular, genero = @genero, nacionalidad = @nacionalidad WHERE (id = @id)">
                                    <SelectParameters>
    	...
    	<div class="row">
                            ...
                            <div class="col-md-6 p-3 mb-2 bg-white text-white border border-dark rounded ">
                             <div style="background-color:#FFFACD" class="text-md-center  rounded text-bold " role="alert">
                                ...
                                <asp:GridView ID="gv_financiero" runat="server" CssClass="table table-hover mt-1 " AutoGenerateColumns="False" DataSourceID="sql_ds_financiero" Font-Size="9pt" DataKeyNames="id_datos_financieros">
                                    <Columns>
                                        <asp:CommandField ShowEditButton="True" />
                                        ...
                                        <asp:BoundField DataField="nua" HeaderText="N.U.A." SortExpression="nua" ReadOnly="True" />
                                        <asp:BoundField DataField="afp" HeaderText="A.F.P." SortExpression="afp" ReadOnly="True" />
                                ...
                                <asp:SqlDataSource ID="sql_ds_financiero" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" SelectCommand="SELECT * FROM [tb_datos_financieros] WHERE (ci = @ci) and gestion='2-2022'" UpdateCommand="UPDATE tb_datos_financieros SET nit =@nit, nroCuenta =@nroCuenta, banco =@banco
where id_datos_financieros=@id_datos_financieros">
                                    <SelectParameters>
