<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DAF_NAL_asistencia_dia_hoy_x_sede.aspx.vb" Inherits="DAF_NAL_asistencia_dia_hoy_x_sede" MasterPageFile="mp_daf_nacional.master" %>
               ...
               <div class="chart">
                    <div class="input-group mb-1">
                        <asp:DropDownList ID="ddl_sede" CssClass ="custom-select form-control-border"  runat="server" DataSourceID="sql_ds_sede" DataTextField="NombreSede" DataValueField="idSede" AutoPostBack="True" AppendDataBoundItems="True">
                            <asp:ListItem Value="0">Seleccion una Sede</asp:ListItem>
                        </asp:DropDownList>
                   ...
                   <asp:SqlDataSource ID="sql_ds_asistencia_hoy" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" SelectCommand="select ci_doc ,(p.nombres +' '+p.primerApellido +' '+p.segundoApellido ) as docente,carrera ,Materia ,sigla_materia,grupo,tipo_clase ,hra_inicio,hra_fin ,hr_ingreso ,hr_salida ,isnull(observaciones ,'Clases en Curso o Por Cursar') as observaciones , observaciones,i.carrera  from tb_ing_sal i
join tb_personal p on i.ci_doc = p.ci 
where p.gestion ='1-2024' and CONVERT(varchar,hora_registro,103) =CONVERT(varchar,getdate(),103) and sede =@sede 
