<%@ Page Language="VB" AutoEventWireup="false" CodeFile="busca_fantasma.aspx.vb" Inherits="busca_fantasma" MasterPageFile="~/mp2.master" %>
                            ...
                            <div class="col-md-6 p-3 mb-2 bg-white text-white border border-dark rounded ">
                              <div style="background-color:#ffc107" class="text-md-center  rounded text-bold " role="alert">
                                ...
                                <asp:Button ID="Button1" runat="server" Text="buscar" />
                                 <asp:Button ID="Button2" runat="server" Text="buscar DATOS" />
                                 <asp:Button ID="Button3" runat="server" Text="inscribir" />
                                <asp:TextBox ID="txt_fechabus" type="date" runat="server"></asp:TextBox>
                                <asp:Button ID="Button4" runat="server" Text="Registrar respaldo" />
                                <asp:GridView ID="gv_fecvha" runat="server" AutoGenerateColumns="False" DataSourceID="sql_ds_fecha">
                                    <Columns>
                                        <asp:BoundField DataField="fecha" HeaderText="fecha" ReadOnly="True" SortExpression="fecha" />
                                    </Columns>
                                </asp:GridView>
                                <asp:SqlDataSource ID="sql_ds_fecha" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" SelectCommand="select getdate() as fecha"></asp:SqlDataSource>
