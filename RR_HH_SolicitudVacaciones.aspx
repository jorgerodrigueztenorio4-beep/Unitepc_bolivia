<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RR_HH_SolicitudVacaciones.aspx.vb" Inherits="RR_HH_SolicitudVacaciones" MasterPageFile="~/mp_rr_hh.master" %>
            ...
            <main class="app-main">
                ...
                <div class="app-content-header">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <h3 class="mb-0">Solicitudes de vacacion</h3>
                            </div>
                                    ...
                                    <form class="needs-validation" novalidate>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-6">
                                                    <label for="validationCustom02" class="form-label">Ingrese el Nro. de C.I.</label>
                                                    <input
                                                        type="text"
                                                        class="form-control"
                                                        id="validationCustom020"
                                                        value="Otto"
                                                        required />
