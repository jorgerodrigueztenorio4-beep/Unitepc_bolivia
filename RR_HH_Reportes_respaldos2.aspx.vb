...
Partial Class RR_HH_Reportes_respaldos2
    ...
    Private Sub RR_HH_Reportes_respaldos2_Unload(sender As Object, e As EventArgs) Handles Me.Unload


        'Me.CrystalReportViewer1.Dispose()
        'Me.CrystalReportViewer1 = Nothing
        'Me.CrystalReportSource1.Dispose()
        'Me.CrystalReportSource1 = Nothing
