<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DIR_CAR_Horarios_dia.aspx.vb" Inherits="DIR_CAR_Horarios_dia" MasterPageFile="~/mp_dir_car.master" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <form id="form1" runat="server">
        ...
        <asp:DropDownList ID="ddl_aula" runat="server" AutoPostBack="True" DataSourceID="sql_ds_aula" DataTextField="nom_aula_lab" DataValueField="id_nomal"></asp:DropDownList>
