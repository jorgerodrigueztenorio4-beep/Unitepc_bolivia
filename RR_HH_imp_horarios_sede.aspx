...
where th.sede =@sede    and th.gestion ='1-2026' and tp.gestion ='1-2026'    group by nombres ,primerApellido,segundoApellido,ci_doc order by docente">
                                                    <SelectParameters>
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Clase y grupo">
            <ItemTemplate>
        ...
        <asp:BoundField DataField="dia" HeaderText="DÍA" ItemStyle-CssClass="text-center fw-bold" />
        ...
        <asp:BoundField DataField="Comun" HeaderText="Comun" ItemStyle-CssClass="text-center" />

        
        <asp:BoundField DataField="gestion" HeaderText="Gestion" ItemStyle-CssClass="text-center" />
...
where h.gestion ='1-2026' and p.gestion ='1-2026' and a.gestion='1-2024' and h.sede =@sede and h.ci_doc =@cidoc
