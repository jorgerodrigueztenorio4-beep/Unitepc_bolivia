<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RR_HH_Lista_Horarios.aspx.vb" Inherits="RR_HH_Lista_Horarios" MasterPageFile="~/mp_rr_hh.master" %>
...
where h.gestion ='1-2026' and p.gestion ='1-2026'  and h.sede =@sede and h.bloque =@bloque and a.gestion='1-2024'
...
join tb_personal p on h.ci_doc = p.ci
join planes_estudios m on d.id_materia = m.id_plan 
where h.id_horario=@id and p.gestion ='1-2026'" UpdateCommand="update tb_designacion 
set horas =@horas
