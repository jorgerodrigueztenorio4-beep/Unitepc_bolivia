...
Partial Class seguimiento_quijarro
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If gv_horaingresaantes.Rows(0).Cells(0).Text < GridView1.Rows(0).Cells(5).Text Then
            ...
            sql_ing_sal0.Insert()
            Page.ClientScript.RegisterStartupScript(Me.GetType(), "Scripts", "<script>alert('Se registro Exitosamente su Ingreso!!!');window.location.href = ""seguimiento_quijarro.aspx"";</script>")
    ...
    Protected Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        If gv_respuesta.Rows.Count > 0 Then
            ...
            ElseIf ddl_cantest.SelectedValue.ToString <> "Cantidad de Estudiantes" Then
                ...
                Page.ClientScript.RegisterStartupScript(Me.GetType(), "Scripts", "<script>alert('Se registro Exitosamente su Salida muchas Gracias!!!');window.location.href = ""seguimiento_quijarro.aspx"";</script>")
            End If
