<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DOCENTE_agregar_datos_financieros.aspx.vb" Inherits="DOCENTE_agregar_datos_financieros" MasterPageFile="~/mp_docentes.master" %>
    	...
    	<div class="row">
                                ...
                                <%-- aqui --%>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="bancos" Class=" form-control  btn-default dropdown-toggle mt-1"  runat="server" >
                                                ...
                                                <option value="Banco Mercantil Santa Cruz">Banco Mercantil Santa Cruz S.A.</option>        
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <asp:SqlDataSource ID="sql_ds_financiero" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" InsertCommand="INSERT INTO tb_datos_financieros(ci, nit, nua, afp, nroCuenta, banco, gestion) VALUES (@ci, @nit, @nua, @afp, @nrocta, @banco, '2-2022')" SelectCommand="SELECT * FROM [tb_datos_financieros]" ProviderName="<%$ ConnectionStrings:unitepc_boliviaConnectionString.ProviderName %>">
                                    <InsertParameters>
                                        ...
                                        <asp:ControlParameter Name="ci" ControlID="txt_ci" PropertyName="Text" />
                                    </InsertParameters>
                                </asp:SqlDataSource>
