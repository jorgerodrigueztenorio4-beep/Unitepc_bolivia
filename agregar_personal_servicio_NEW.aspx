<%@ Page Language="VB" AutoEventWireup="false" CodeFile="agregar_personal_servicio_NEW.aspx.vb" Inherits="agregar_personal_servicio_NEW" MasterPageFile="mp_rr_hh.master" %>
...
where ci=@ci and gestion ='1-2025'" UpdateCommand="UPDATE tb_horario SET ci_doc = @ci WHERE (id_horario = @idhorario)" ProviderName="<%$ ConnectionStrings:unitepc_boliviaConnectionString.ProviderName %>">
            <InsertParameters>
