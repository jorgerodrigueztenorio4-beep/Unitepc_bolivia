...
Partial Class RR_HH_Reportes_respaldos2_1
    Inherits System.Web.UI.Page
    ' Dim ds1 As New RR_HH_2_1
    Dim ds01 As New DataSet("RR_HH_2_1")
    ...
    Private Sub GridView1_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GridView1.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            suma = suma + e.Row.Cells(9).Text
            suma2 = suma2 + e.Row.Cells(8).Text
        ElseIf e.Row.RowType = DataControlRowType.Footer Then
            e.Row.Cells(10).Text = "Total Programado"
            e.Row.Cells(7).Text = "Total Ejecutado"
            e.Row.Cells(9).Text = suma
            e.Row.Cells(8).Text = suma2
            txt_hra_eje.Text = e.Row.Cells(8).Text
        ...
        'If e.Row.RowType = DataControlRowType.DataRow Then
        If e.Row.Cells(8).Text <> e.Row.Cells(9).Text Then
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles GridView1.SelectedIndexChanged
        txt_id_ingsal.Text = GridView1.SelectedDataKey.Value.ToString()
        sql_ds_horas.Delete()
        GridView1.DataBind()
