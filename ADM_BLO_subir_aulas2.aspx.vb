...
Partial Class ADM_BLO_subir_aulas2
    ...
    Private Sub DAF_LOCAL_subir_aulas_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Session("idus") <> "" Then
            ...
            If ddl_bloque.SelectedItem.Text = "JUAN PABLO II (A)" Or ddl_bloque.SelectedItem.Text = "JUAN PABLO II (B)" Or ddl_bloque.SelectedItem.Text = "JUAN PABLO II (C)" Then
                btn_agregar.Visible = True

            End If

            If ddl_bloque.SelectedItem.Text = "COLONIAL" Or ddl_bloque.SelectedItem.Text = "FLORIDA NORTE" Then
