<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RR_HH_Datos_docentes_afi.aspx.vb" Inherits="RR_HH_Datos_docentes_afi" MasterPageFile="~/mp_rr_hh.master" %>
    	...
    	<div class="row">
                            ...
                            <div class="col-md-12 p-3 mb-2 bg-white text-white  rounded ">
                              <div style="background-color:#FFFACD" class="text-md-center  rounded text-bold " role="alert">
                               Lista de Docentes Contrato de Afiliacion
                            </div>
...
where tco.tipoContrato ='Afiliacion' and td.comun is null"></asp:SqlDataSource>
                                </div>
            </div>
         </div>
          </form>
