<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DIR_CAR_Reportes_respaldos2.aspx.vb" Inherits="DIR_CAR_Reportes_respaldos2" MasterPageFile="mp_dir_car2.master" %>
...
<%--                                    <asp:DropDownList ID="ddl_respaldo_de" CssClass="form-control btn btn-default dropdown-toggle mt-1"  runat="server">
                                ...
                                <asp:SqlDataSource ID="sql_ds_carrera" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" SelectCommand="SELECT * FROM [tb_carreras] order by cardes"></asp:SqlDataSource>--%>                               <asp:DropDownList ID="ddl_docente" CssClass="form-control btn btn-default dropdown-toggle mt-1"  runat="server" DataSourceID="sql_ds_docente" DataTextField="docente" DataValueField="ci_doc" Font-Size="10pt">
