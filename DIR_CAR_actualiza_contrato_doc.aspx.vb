...
Partial Class DIR_CAR_actualiza_contrato_doc
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Response.Write("<script>alert(""Se Registro el Contrato del Docente Exitosamente"");window.location.href = ""DIR_CAR_actualiza_contrato_doc.aspx"";</script>")
