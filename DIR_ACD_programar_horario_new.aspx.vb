...
Partial Class DIR_ACD_programar_horario_new
    ...
    Private Sub DIR_CAR_programar_horario_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Session("idus") <> "" Then
            ...
            If txt_id_sede.Text = "5" Then
                Button5.Visible = True

            End If
            If txt_id_sede.Text = "6" Then
                Button5.Visible = True
    ...
    Protected Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Response.Write("<script>alert(""Se Registro los Datos Exitosamente"");window.location.href = ""DIR_ACD_programar_horario_new.aspx"";</script>")
