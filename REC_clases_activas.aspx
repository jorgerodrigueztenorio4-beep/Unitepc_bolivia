<%@ Page Language="VB" AutoEventWireup="false" CodeFile="REC_clases_activas.aspx.vb" Inherits="REC_clases_activas" MasterPageFile="mp_rectorado.master" %>
     ...
     <div class=" container-fluid ">
    	<div class="row">
                    ...
                    <asp:SqlDataSource runat="server" ID="sql_bloque" ConnectionString='<%$ ConnectionStrings:unitepc_boliviaConnectionString %>' SelectCommand="SELECT * FROM [tb_bloques]">
                                ...
                                <asp:GridView ID="gv_clases" CssClass ="table  table-hover mt-1 " runat="server" AutoGenerateColumns="False" DataSourceID="sql_ds_clases">
                                    <Columns>
                                        <asp:BoundField DataField="docente" HeaderText="Docente" ReadOnly="True" SortExpression="docente" />
                                        <asp:BoundField DataField="ci_doc" HeaderText="C.I." SortExpression="ci_doc" />
                                        <asp:BoundField DataField="hora_inicio" HeaderText="hora de Inicio en el Horairo" SortExpression="hora_inicio" />
