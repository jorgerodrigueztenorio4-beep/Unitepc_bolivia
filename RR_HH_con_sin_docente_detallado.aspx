<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RR_HH_con_sin_docente_detallado.aspx.vb" Inherits="RR_HH_con_sin_docente_detallado" MasterPageFile="~/mp_rr_hh.master" %>
     ...
     <section class="content">
      <div class="container-body">
        <div class="row">
              ...
              <div class="card-header">
                <h3 class="card-title">Clases con docente : <asp:Label ID="lbl_condoc" runat="server" Text=""></asp:Label></h3>
              </div>
            <div class="card-body">
...
ORDER BY CASE WHEN th.dia = 'Lunes' THEN 1 WHEN th.dia='Martes' THEN 2 WHEN th.dia='Miercoles' THEN 3 WHEN th.dia='Jueves' THEN 4 WHEN th.dia='Viernes' THEN 5  WHEN th.dia='Sabado' THEN 6  END,hora_inicio ">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Clases sin docente :  <asp:Label ID="lbl_sin_doc" runat="server" Text=""></asp:Label></h3>
              </div>
              <div class="card-body">
