...
Partial Class SEC_DIR_ACD_designar_comun
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        ClientScript.RegisterStartupScript(Me.GetType(), "mensaje", "<script>swal({title:""UNITEPC"", text:""Materia Comun Registrada Exitosamente"", type: ""success"" }, function(){window.location.href = ""SEC_DIR_ACD_designar_comun.aspx"";});</script>")
    End Sub
End Class
