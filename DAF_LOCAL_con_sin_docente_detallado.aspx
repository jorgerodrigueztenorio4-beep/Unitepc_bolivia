<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DAF_LOCAL_con_sin_docente_detallado.aspx.vb" Inherits="DAF_LOCAL_con_sin_docente_detallado" MasterPageFile="~/mp_daf_local.master" %>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <asp:SqlDataSource ID="sql_ds_sede" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" SelectCommand="SELECT idSede, NombreSede, nombrecorto, id_rrhh FROM tb_sedes WHERE (idSede = @sede)">
                                <SelectParameters>
                                    <asp:ControlParameter Name="sede" ControlID="txt_idsde" PropertyName="Text" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                        </div>
                    </div>
...
where td.carrera =@carrera and th.gestion ='1-2026' and tp.gestion ='1-2026' and th.sede =@sede  and a.gestion ='1-2024' and th.ci_doc &lt;&gt;'0'
...
join tb_personal per on th.ci_doc = per.ci 
join tb_aula a on th.aula = a.id_nomal 
where th.gestion ='-2026' and per.gestion ='1-2026' and a.gestion ='1-2024' and th.sede =@sede and p.codcar =@carrera">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="ddl_sede" Name="sede" PropertyName="SelectedValue" />
                                        <asp:ControlParameter ControlID="ddl_carrera" Name="carrera" PropertyName="SelectedValue" />
                                    </SelectParameters>
