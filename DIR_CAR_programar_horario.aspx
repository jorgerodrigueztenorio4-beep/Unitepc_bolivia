<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DIR_CAR_programar_horario.aspx.vb" Inherits="DIR_CAR_programar_horario" MasterPageFile="~/mp_dir_car.master" %>
...
<asp:Content ID="Content1" runat="server" contentplaceholderid="ContentPlaceHolder1">
    ...
    <%--Tipo de Clase--%>
                                ...
                                <asp:SqlDataSource runat="server" ID="sql_ds_aula" ConnectionString='<%$ ConnectionStrings:unitepc_boliviaConnectionString %>' SelectCommand="SELECT * FROM [tb_aula] where bloque=@bloque order by nom_aula_lab" ProviderName="<%$ ConnectionStrings:unitepc_boliviaConnectionString.ProviderName %>">
                                    <SelectParameters>
	  ...
	  where ci_usuario =@ciusu and designado='No'" UpdateCommand="UPDATE tb_horario SET designado = 'Si' WHERE (id_horario = @id_horario)">
                                ...
                                <asp:DropDownList ID="ddl_materias" runat="server" CssClass="form-control btn btn-outline-info dropdown-toggle mt-1" AutoPostBack="True" DataSourceID="sql_ds_materias" DataTextField="Materia" DataValueField="id_plan" AppendDataBoundItems="True">
      ...
      <asp:TextBox ID="txt_hrafin" runat="server" Visible="false"></asp:TextBox>
           ...
           <asp:SqlDataSource ID="sql_ds_designacion" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" InsertCommand="INSERT INTO tb_designacion(id_horario, id_materia, fecha_creacion, id_sede, plan_est, horas) VALUES (@idhorario, @id_materia, GETDATE(), @id_sede, @plan , @horas)" ProviderName="<%$ ConnectionStrings:unitepc_boliviaConnectionString.ProviderName %>">
               <InsertParameters>
                   <asp:ControlParameter ControlID="ddl_clases_prog" Name="idhorario" PropertyName="SelectedValue" />
