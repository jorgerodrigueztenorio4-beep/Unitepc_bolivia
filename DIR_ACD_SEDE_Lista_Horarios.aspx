<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DIR_ACD_SEDE_Lista_Horarios.aspx.vb" Inherits="DIR_ACD_SEDE_Lista_Horarios" MasterPageFile="mp_dir_academico_sedes.master" %>
                              ...
                              <div style="background-color:#FFCC00" class="text-md-center  rounded text-bold " role="alert">
                               Lista de Horarios
                                 ...
                                 <div class="input-group mb-1">
                                     <asp:DropDownList ID="ddl_carrera" CssClass="form-control btn btn-default dropdown-toggle mt-1" runat="server" DataSourceID="sql_ds_carrera" DataTextField="CARDES" DataValueField="CARSIGLA" AutoPostBack="True" AppendDataBoundItems="True">
...
<ControlStyle CssClass="btn btn-primary mt-1 "></ControlStyle>
                                             ...
                                             <asp:BoundField DataField="horas" HeaderText="Horas P.E." SortExpression="horas" >
                                             <ItemStyle BackColor="#ede4ff" />
                                             </asp:BoundField>
                                             ...
                                             <asp:BoundField DataField="hora_fin" HeaderText="Hora de Fin" SortExpression="hora_fin" />
                                              <asp:BoundField DataField="Hras_academica" HeaderText="Horas Academicas" SortExpression="Hras_academica" >
...
where h.gestion ='2-2022' and p.gestion ='2-2022' and d.carrera =@carrera and h.sede =@sede  and h.ci_doc &lt;&gt;'0'" UpdateCommand="update d set d.horas =@horas
 from tb_horario h
join tb_designacion d on d.id_horario=h.id_horario 
join tb_personal p on h.ci_doc = p.ci 
