<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ADM_BLO_Reportes_respaldos.aspx.vb" Inherits="ADM_BLO_Reportes_respaldos" MasterPageFile="mp_adm_blo.master" %>
...
where th.sede =@sede and p.codcar =@sigcar  and tp.gestion ='1-2024' and th.gestion ='1-2024' group by nombres ,primerApellido,segundoApellido,ci_doc order by docente">
                                    <SelectParameters>
