...
Partial Class DIR_CAR_agregar_datos_docente2
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            ...
            Response.Write("<script>alert(""Se Registro al Docente Exitosamente"");window.location.href = ""DIR_CAR_agregar_datos_docente2.aspx"";</script>")
        End If
