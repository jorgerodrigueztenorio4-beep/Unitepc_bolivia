<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RR_HH_datos_docente2.aspx.vb" Inherits="RR_HH_datos_docente2" MasterPageFile="~/mp_rr_hh.master" %>
                            ...
                            <div class="col-md-12 p-3 mb-2 bg-white text-white border border-dark rounded ">
                              <div style="background-color:#FFFACD" class="text-md-center  rounded text-bold " role="alert">
                                Datos Personales del Docente
                                     ...
                                     <asp:SqlDataSource ID="sql_docente" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" SelectCommand="SELECT nombres + ' ' + primerApellido + ' ' + segundoApellido AS docente, ci FROM tb_personal
where (nombres like '%'+@buscar+'%' or primerApellido like '%'+@buscar+'%' or segundoApellido  like '%'+@buscar+'%') and gestion ='2-2022' order by docente">
                                         <SelectParameters>
                                ...
                                <asp:GridView ID="gv_datos_doc" CssClass ="table table-hover mt-1 " runat="server" AutoGenerateColumns="False" DataSourceID="sql_ds_docente" Font-Size="9pt" DataKeyNames="id">
                                    <Columns>
                                        <asp:CommandField ShowEditButton="True" ControlStyle-CssClass ="btn btn-outline-primary mt-1 " />
                                        ...
                                        <asp:BoundField DataField="fecha_actualizacion" HeaderText="fecha_actualizacion" SortExpression="fecha_actualizacion"   ReadOnly="True" />
                                    </Columns>
                                </asp:GridView>
                                <asp:SqlDataSource ID="sql_ds_docente" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" SelectCommand="SELECT * FROM [tb_personal] where ci=@cidoc and gestion ='2-2022'" UpdateCommand="UPDATE tb_personal SET direccion = @direccion, genero = @genero, primerApellido = @primerApellido, segundoApellido = @segundoApellido, email = @email, extension = @extension, fechaNacimiento = @fechaNacimiento, celular = @celular, nacionalidad = @nacionalidad, telefono = @telefono, estadoCivil = @estadoCivil WHERE (id = @id)">
                                    <SelectParameters>
                                    ...
                                    <UpdateParameters>
                                        ...
                                        <asp:Parameter Name="segundoApellido" />
                                        ...
                                        <asp:Parameter Name="estadoCivil" />
                                    </UpdateParameters>
                                </asp:SqlDataSource>
                            ...
                            <div class="col-md-6 p-3 mb-2 bg-white text-white border border-dark rounded ">
                             <div style="background-color:#FFFACD" class="text-md-center  rounded text-bold " role="alert">
                                ...
                                <asp:GridView ID="gv_financiero" runat="server" CssClass="table-hover mt-1 " AutoGenerateColumns="False" DataSourceID="sql_ds_financiero" Font-Size="9pt" DataKeyNames="id_datos_financieros">
                                    <Columns>
                                        <asp:CommandField ShowEditButton="True" ControlStyle-CssClass ="btn btn-outline-primary m-1 " />
                                ...
                                <asp:SqlDataSource ID="sql_ds_financiero" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" SelectCommand="SELECT * FROM [tb_datos_financieros] WHERE (ci = @ci)  and gestion ='2-2022'" UpdateCommand="UPDATE tb_datos_financieros SET nit = @nit, nroCuenta = @nroCuenta, banco = @banco, gestion = '2-2022' WHERE (id_datos_financieros = @id_datos_financieros)">
                                    <SelectParameters>
