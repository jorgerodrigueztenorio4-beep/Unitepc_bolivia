<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RR_HH_ultima_lista3.aspx.vb" Inherits="RR_HH_ultima_lista3" MasterPageFile="~/mp_rr_hh.master" %>
                            ...
                            <div class="col-md-12 p-3 mb-2 bg-white text-white border  rounded ">
                              <div style="background-color:#FFFACD" class="text-md-center  rounded text-bold " role="alert">
                               Lista de Materias y Docentes Designados por Carrera
                                ...
                                <asp:GridView ID="gv_formulario" runat="server" AutoGenerateColumns="False" DataSourceID="sql_ds_formulario" Font-Size="9pt" Font-Names="Arial">
                                    <Columns>
                                ...
                                <asp:SqlDataSource ID="sql_ds_formulario" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" SelectCommand="select s.NombreSede,c.CARDES ,p.nombres ,(p.primerApellido +' '+p.segundoApellido )as apellidos ,p.id,h.ci_doc,p.extension,p.fechaNacimiento,p.estadoCivil  
...
where h.gestion ='2-2023' and p.gestion ='2-2023' and f.gestion ='2-2023' and sede=@sede and d.carrera =@carrera and d.comun is null
