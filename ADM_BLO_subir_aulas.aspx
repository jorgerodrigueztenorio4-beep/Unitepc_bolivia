<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ADM_BLO_subir_aulas.aspx.vb" Inherits="ADM_BLO_subir_aulas" MasterPageFile="~/mp_adm_blo.master" %>
    ...
    <asp:Label ID="lbl_cargo"  runat="server" Text=""></asp:Label>
     ...
     <div class=" container-fluid ">
    	...
    	<div class="row">
                            ...
                            <div class="col-md-6 p-3 mb-2 bg-white text-white ">
                              <div  class="text-md-center  rounded text-bold " role="alert">
                                  <h5>Datos para el registro de un ambiente</h5>
                            </div>
                    ...
                    <asp:Button ID="btn_agregar" runat="server" CssClass ="form-control btn btn-primary mt-1 " Text="Registrar datos"  />
                            ...
                            <div class="col-md-6 p-3 mb-2 bg-white text-white ">
                                <div  class="text-md-center  rounded text-bold " role="alert">
      <h5>Listado de ambientes por bloque</h5>
</div>
...
where Sede =@sede  and bloque =@bloque and gestion='1-2024' order by am.nombre , nom_aula_lab " DeleteCommand="DELETE FROM tb_aula WHERE (id_nomal = @id_nomal)" UpdateCommand="UPDATE tb_aula SET capacidad = @capacidad WHERE (id_nomal = @id_nomal)">
                                    <DeleteParameters>
          ...
          <asp:TextBox ID="txt_idsde" runat="server" Visible="False" Width="162px"></asp:TextBox>
