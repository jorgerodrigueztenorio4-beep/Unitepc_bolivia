<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ADM_horarios_Virtual.aspx.vb" Inherits="ADM_horarios_Virtual" MasterPageFile="~/mp_daf_nacional.master" %>
...
where th.tipo_clase ='virtual' and th.sede=@sede  and p.codcar =@car
...
" DeleteCommand="delete tb_horario where id_horario =@id_hor" UpdateCommand="UPDATE tb_horario SET designado = 'No'  WHERE (id_horario = @id_horario)">
                                    <DeleteParameters>
