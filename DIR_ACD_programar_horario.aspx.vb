...
Partial Class DIR_ACD_programar_horario
    ...
    Protected Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        txt_id_horarioselec.Text = gv_clases.Rows(0).Cells(0).Text
        ...
        Response.Write("<script>alert(""Se Registro los Datos Exitosamente"");window.location.href = ""DIR_ACD_programar_horario.aspx"";</script>")
