<%@ Page Language="VB" AutoEventWireup="false" CodeFile="COORDINADOR_lista_docentes.aspx.vb" Inherits="COORDINADOR_lista_docentes" MasterPageFile="~/mp_coordinadores.master" %>
...
<ControlStyle CssClass="btn btn-primary mt-1 " Font-Size="9pt"></ControlStyle>
  ...
  Revisar el Correo electronico del Docente ya que a ese correo se enviaran sus accesos.
                              ...
                              <asp:SqlDataSource ID="sql_ds_docente_selec" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" SelectCommand="SELECT id, nombres, primerApellido, segundoApellido, email, ci, extension, fechaNacimiento, estadoCivil, direccion, telefono, celular, genero, nacionalidad FROM tb_personal WHERE (ci = @ci) and gestion='2-2022'">
                                  <SelectParameters>
