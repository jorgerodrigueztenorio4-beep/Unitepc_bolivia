<%@ Page Language="VB" AutoEventWireup="false" CodeFile="COORDINADOR_agregar_datos_docente.aspx.vb" Inherits="COORDINADOR_agregar_datos_docente" MasterPageFile="~/mp_coordinadores.master" %>
                       ...
                       <asp:GridView ID="gv_personal" CssClass="table table-hover mt-1 " runat="server" AutoGenerateColumns="False" DataSourceID="sql_ds_docnete" Font-Size="10pt">
                           <Columns>
                               ...
                               <asp:BoundField DataField="nacionalidad" HeaderText="Nacionalidad" SortExpression="nacionalidad" />
                                ...
                                <asp:SqlDataSource ID="sql_ds_docnete" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" InsertCommand="INSERT INTO tb_personal(nombres, primerApellido, segundoApellido, email, ci, extension, celular, fecha_registro, fecha_actualizacion) VALUES (@nombres, @app, @apm, @email, @ci, @extci, @cel, GETDATE(), GETDATE())" SelectCommand="SELECT * FROM [tb_personal] where ci=@ci">
                                    <InsertParameters>
