...
Partial Class RR_HH_Reportes_respaldos_fuera
    ...
    Protected Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        rptdocumento.SetParameterValue("nombre", txt_ci_doc_fu.Text)
        ...
        rptdocumento.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, True, txt_ci_doc_fu.Text)
    ...
    Protected Sub txt_ci_doc_fu_TextChanged(sender As Object, e As EventArgs) Handles txt_ci_doc_fu.TextChanged
        gv_docente.DataBind()
