...
Partial Class ADM_BLO_reg_ingreso
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles GridView1.SelectedIndexChanged
        txt_id_horario2.Text = GridView1.SelectedRow.Cells(1).Text
        lbl_materia.Text = "Materia : " + GridView1.SelectedRow.Cells(8).Text
        lbl_dia.Text = "Dia : " + GridView1.SelectedRow.Cells(4).Text
        lbl_hi.Text = "Hora de Inicio : " + GridView1.SelectedRow.Cells(6).Text
        lbl_hf.Text = "Hora de Conclusion : " + GridView1.SelectedRow.Cells(7).Text
    End Sub
End Class
