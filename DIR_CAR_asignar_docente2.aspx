<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DIR_CAR_asignar_docente2.aspx.vb" Inherits="DIR_CAR_asignar_docente2" MasterPageFile="~/mp_dir_car2.master" %>
    	...
    	<div class="row">
                            ...
                            <div class="col-md-12 p-3 mb-2 bg-white text-white border border-dark rounded ">
                              <div style="background-color:#FFCC00" class="text-md-center  rounded text-bold " role="alert">
                               Lista de Horarios para Asignar Docente
                            </div>
                                 <div class="input-group mb-1">

                                 

                                <asp:DropDownList ID="ddl_sede" CssClass="form-control btn btn-default dropdown-toggle mt-1 border-dark fa-bold " runat="server" DataSourceID="sql_ds_sede" DataTextField="NombreSede" DataValueField="idSede" AppendDataBoundItems="True">
                                ...
                                <asp:DropDownList ID="ddl_carrera" CssClass="form-control btn btn-default dropdown-toggle mt-1 border-dark " runat="server" AutoPostBack="True" DataSourceID="sql_ds_carrera" DataTextField="CARDES" DataValueField="CARSIGLA" AppendDataBoundItems="True">
                                    <asp:ListItem Value="0">Seleccione una Carrera</asp:ListItem>
                                </asp:DropDownList>
                                <asp:SqlDataSource ID="sql_ds_carrera" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" SelectCommand="SELECT id_carrera, CARSIGLA, CARDES, FACULTAD FROM tb_carreras WHERE (CARSIGLA = @siga)">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="txt_sigla_car" Name="siga" PropertyName="Text" />
                                    </SelectParameters>
                                     </asp:SqlDataSource>
                                     </div>
                                <asp:GridView ID="gv_horarios_v" CssClass="table table-hover mt-1 " runat="server" AutoGenerateColumns="False" DataSourceID="sql_virtuales" Font-Size="9pt" DataKeyNames="id_horario">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="ci_doc" SortExpression="ci_doc">
                                            <EditItemTemplate>
                                                <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="sql_ds_docnete" DataTextField="docente" DataValueField="ci" SelectedValue='<%# Bind("ci_doc") %>'>
                                                </asp:DropDownList>
                                                <asp:SqlDataSource ID="sql_ds_docnete" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" SelectCommand="SELECT nombres + ' ' + primerApellido + ' ' + segundoApellido AS docente, ci FROM tb_personal  where gestion ='2-2022'  ORDER BY docente"></asp:SqlDataSource>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:BoundField DataField="nom_aula_lab" HeaderText="nom_aula_lab" ReadOnly="True" SortExpression="nom_aula_lab" />
                                        <asp:BoundField DataField="SiglaP" HeaderText="SiglaP" ReadOnly="True" SortExpression="SiglaP" />
                                        <asp:BoundField DataField="Sis_plan" HeaderText="Sis_plan" ReadOnly="True" SortExpression="Sis_plan" />
                                    </Columns>
