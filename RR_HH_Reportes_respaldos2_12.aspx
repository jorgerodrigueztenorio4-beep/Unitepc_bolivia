<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RR_HH_Reportes_respaldos2_12.aspx.vb" Inherits="RR_HH_Reportes_respaldos2_12" MasterPageFile="mp_rr_hh.master" %>
...
where th.sede =@sede and p.codcar =@sigcar   and th.gestion ='1-2024' and tp.gestion ='1-2024'    group by nombres ,primerApellido,segundoApellido,ci_doc order by docente">
                                    <SelectParameters>
                 ...
                 <asp:GridView ID="GridView1" runat="server" CssClass ="table-hover mt-1 " AutoGenerateColumns="False" DataSourceID="sql_ds_horas" Font-Size="8pt" ShowFooter="True" Font-Names="Consolas">
                     <Columns>
                         ...
                         <asp:BoundField DataField="observaciones" HeaderText="observaciones" SortExpression="observaciones" />
                              ...
                              <asp:SqlDataSource ID="sql_ds_horas" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" SelectCommand="  SELECT 
    ti.ci_doc,
    ti.Materia,
    ti.tema_avance,
    ti.carrera,
  ...
  FROM tb_ing_sal ti
  WHERE TI.ci_doc = @ci
    AND TI.carrera = @carrera
    AND ti.sede = @sede
	and ti.gestion ='1-2024'
    AND TRY_CONVERT(DATE, TI.hr_ingreso, 120) BETWEEN TRY_CONVERT (date,@fechaini,120) AND DATEADD(day, 0, TRY_CONVERT (date,@fecha_fin,120))
  ORDER BY  TI.hr_ingreso ;" InsertCommand="INSERT INTO tb_ajustes(ci_doc, fecha_ini, fecha_fin, carrera, ajuste, modificado_por, fecha_ajuste, sede, tipo_clase) VALUES (@cidoc, @feha_ini, @fecha_fin, @carrera, @ajuste, @modpor, GETDATE(), @sede, @tipoclase)">
                                  <InsertParameters>
                                  ...
                                  <SelectParameters>
                                      <asp:ControlParameter ControlID="ddl_docente" Name="ci" PropertyName="SelectedValue" DefaultValue="" />
                                      <asp:ControlParameter Name="carrera" ControlID="ddl_carrera" PropertyName="SelectedValue" />
                                      <asp:ControlParameter ControlID="ddl_sede" Name="sede" PropertyName="SelectedValue" Type="String" DefaultValue="" />
                                      <asp:Parameter DefaultValue="2024-03-08" Name="fechaini" Type="DateTime" />
                                      <asp:Parameter DefaultValue="2024-03-19" Name="fecha_fin" Type="DateTime" />
                                  </SelectParameters>
                              </asp:SqlDataSource>
