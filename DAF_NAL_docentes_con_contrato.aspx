<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DAF_NAL_docentes_con_contrato.aspx.vb" Inherits="DAF_NAL_docentes_con_contrato" MasterPageFile="~/mp_daf_nacional.master" %>
...
<asp:Content ID="Content1" runat="server" contentplaceholderid="ContentPlaceHolder1">
    ...
    <asp:Label ID="lbl_cargo"  runat="server" Text=""></asp:Label>
        ...
        <h3>Estadistica de Materias con Docente por carrera</h3>
          <div class="col-md-12 p-3 mb-2 bg-white text-white border  rounded ">
                              
              <div class="input-group mb-1">
                                <asp:DropDownList ID="ddl_sede" CssClass="form-control  mt-1 " runat="server" DataSourceID="sql_ds_sede" DataTextField="NombreSede" DataValueField="idSede" AutoPostBack="True" AppendDataBoundItems="True">
                                ...
                                <asp:DropDownList ID="ddl_carrera" CssClass="form-control   mt-1 " runat="server" DataSourceID="sql_ds_carrera" DataTextField="CARDES" DataValueField="CARSIGLA" AutoPostBack="True" AppendDataBoundItems="True">
...
where th.sede =@sede and p.codcar =@sigcar  and tp.gestion ='2-2025' ">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="ddl_sede" Name="sede" PropertyName="SelectedValue" />
     ...
     <div class=" container-fluid ">
        ...
        <!-- Small Box (Stat card) -->
        <h5 class="mb-2 mt-4">Estadistica de Materias</h5>
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                ...
                <p>Materias con Docente Asignado</p>
              </div>
                 <h3>
