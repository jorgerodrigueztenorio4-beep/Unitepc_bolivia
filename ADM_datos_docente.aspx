<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ADM_datos_docente.aspx.vb" Inherits="ADM_datos_docente" MasterPageFile="~/mp2.master" %>
    	...
    	<div class="row">
                            ...
                            <div class="col-md-12 p-3 mb-2 bg-white text-white border border-dark rounded ">
                              <div style="background-color:#FFFACD" class="text-md-center  rounded text-bold " role="alert">
                                ...
                                <asp:DropDownList ID="ddl_docente" CssClass="form-control  btn btn-default dropdown-toggle mt-1" runat="server" DataSourceID="sql_docente_bus" DataTextField="nombre" DataValueField="ci" AppendDataBoundItems="True" AutoPostBack="True">
                                    <asp:ListItem Value="0">Seleccione un docente</asp:ListItem>
                                </asp:DropDownList>
                            <asp:SqlDataSource ID="sql_docente_bus" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" SelectCommand="SELECT ([nombres]+' '+ [primerApellido]+' '+ [segundoApellido]) as nombre, [ci] FROM [tb_personal]"></asp:SqlDataSource>
                            ...
                            <div class="col-md-4 p-3 mb-2 bg-white text-white border border-dark rounded ">
                             <div style="background-color:#FFFACD" class="text-md-center  rounded text-bold " role="alert">
                                ...
                                <asp:SqlDataSource ID="sql_ds_financiero" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" SelectCommand="SELECT * FROM [tb_datos_financieros] WHERE ([ci] = @ci)">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="ddl_docente" Name="ci" PropertyName="SelectedValue" Type="String" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                                </div>
             <div class="col-md-4 p-3 mb-2 bg-white text-white border border-dark rounded ">
