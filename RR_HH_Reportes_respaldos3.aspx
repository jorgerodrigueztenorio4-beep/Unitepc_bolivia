<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RR_HH_Reportes_respaldos3.aspx.vb" Inherits="RR_HH_Reportes_respaldos3" MasterPageFile="mp_rr_hh.master" %>
...
<%--                                    <asp:DropDownList ID="ddl_respaldo_de" CssClass="form-control btn btn-default dropdown-toggle mt-1"  runat="server">
                               ...
                               <asp:DropDownList ID="ddl_docente" CssClass="form-control btn btn-default dropdown-toggle mt-1"  runat="server" Font-Size="10pt" AutoPostBack="True" Visible="False">
...
where th.sede =@sede and tp.gestion='2-2025' and th.gestion ='2-2025'  and (p.codcar ='carcpu' or p.codcar ='caradm' or p.codcar ='carico' or p.codcar ='CARCAD' or p.codcar ='CARCCP' or p.codcar ='CARCIC' or p.codcar ='CARECO')
...
group by nombres ,primerApellido,segundoApellido,ci_doc order by docente">
                                ...
                                <asp:Button ID="Button1" CssClass =" form-control  btn btn-primary mt-1 " runat="server" Text="Buscar clases" Visible="False" />
                                ...
                                <asp:Button ID="Button3" runat="server" CssClass =" form-control   btn-danger  mt-1 "  Text="Grabar Ajuste" Visible="False" />
                                 <asp:Button ID="Button2" CssClass =" form-control  btn-info mt-1 " runat="server" Text="Extraer Reportes" />
  ...
  <%--  <asp:GridView ID="gv_cargos" runat="server" Visible ="false"  AutoGenerateColumns="False" DataSourceID="sql_ds_cargo">
    ...
    <asp:TextBox ID="txt_id_cargo"  Visible ="false"  runat="server"></asp:TextBox>
     ...
     <asp:TextBox ID="txt_siglacar" runat="server" Visible="False"></asp:TextBox>
      ...
      <asp:GridView ID="gv_docentes" runat="server" AutoGenerateColumns="False" Visible="False">
    <Columns>
        <asp:BoundField DataField="docente" HeaderText="Docente" />
        <asp:BoundField DataField="ci_doc" HeaderText="CI" />
    </Columns>
</asp:GridView>
