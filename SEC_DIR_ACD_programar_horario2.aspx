<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SEC_DIR_ACD_programar_horario2.aspx.vb" Inherits="SEC_DIR_ACD_programar_horario2" MasterPageFile="~/mp_sec_dir_academico.master" %>
...
where  designado='No' and th.gestion ='2-2022' and th.sede ='1'" DeleteCommand="DELETE FROM tb_horario WHERE (id_horario = @id_horario)">
                                                   <DeleteParameters>
...
WHERE (h.sede = @sede) AND (h.bloque = @bloque) AND (h.dia = @dia) AND (h.aula = @aula) order by hora_inicio">
                                                   <SelectParameters>
                                                       <asp:ControlParameter ControlID="ddl_sede" Name="sede" PropertyName="SelectedValue" />
                                                       <asp:ControlParameter ControlID="ddl_bloque" Name="bloque" PropertyName="SelectedValue" />
...
where  gestion ='2-2022' and  dia =@dia and sede=@sede and aula=@aula  and @hi&lt; hora_fin and @hi&gt;= hora_inicio 
">
                                                   <SelectParameters>
                                                       <asp:ControlParameter ControlID="ddl_dia" Name="dia" PropertyName="SelectedValue" />
                                                       <asp:ControlParameter ControlID="ddl_sede" Name="sede" PropertyName="SelectedValue" />
...
where  gestion ='2-2022' and  dia =@dia and sede=@sede and aula=@aula  and @hf&gt; hora_inicio and @hf&lt;=hora_fin 
">
                                                   <SelectParameters>
                                                       <asp:ControlParameter ControlID="ddl_dia" Name="dia" PropertyName="SelectedValue" />
                                                       <asp:ControlParameter ControlID="ddl_sede" Name="sede" PropertyName="SelectedValue" />
