<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DIR_ACD_pivot.aspx.vb" Inherits="DIR_ACD_pivot" MasterPageFile="~/mp_dir_academico.master" %>
    ...
    <asp:Label ID="lbl_cargo"  runat="server" Text=""></asp:Label>
     ...
     <div class=" container-fluid ">
    	<div class="row">
            ...
            <asp:GridView ID="gv_pivot" runat="server" AutoGenerateColumns="False">
                <HeaderStyle BackColor="#D4EDDA" />
            </asp:GridView>
            <asp:GridView ID="GridView1" CssClass="table table-hover mt-1 " runat="server" Font-Size="9pt">
                <HeaderStyle BackColor="#D4EDDA" />
            </asp:GridView>
