<%@ Page Language="VB" AutoEventWireup="false" CodeFile="seguimiento_cochabamba1.aspx.vb" Inherits="seguimiento_cochabamba1" MasterPageFile="mp_cbba.master" %>
                ...
                <div class="card-body">
                                ...
                                <asp:GridView ID="GridView1"  runat="server" CssClass ="table table-hover mt-1 " AutoGenerateColumns="False" DataSourceID="sql_ds_horario"  Font-Size="9pt" Font-Names="Consolas">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="hora_inicio" HeaderText="Hora de Ingreso" SortExpression="hora_inicio" />
                                        <asp:BoundField DataField="hora_fin" HeaderText="Hora de Salida" SortExpression="hora_fin" />
...
where tp.ci =@ci
and th.gestion='2-2023' and tp.gestion='2-2023' and td.horas &gt;'0' and ta.gestion='2-2023'
...
ORDER BY CASE WHEN th.dia = 'Lunes' THEN 1 WHEN th.dia='Martes' THEN 2 WHEN th.dia='Miercoles' THEN 3 WHEN th.dia='Jueves' THEN 4 WHEN th.dia='Viernes' THEN 5  WHEN th.dia='Sabado' THEN 6  END">
 ...
 WHERE 
(th.ci_doc =@ci) AND (th.gestion = '2-2023') AND (th.sede = '1') and tp.gestion='2-2023' and ta.gestion='2-2023'
AND (CONVERT (time, SYSDATETIME(), 114) &gt;= DATEADD(MINUTE, - 5, CONVERT (time, CONVERT (time, th.hora_inicio, 114)))) 
and CONVERT (time, SYSDATETIME(),114)&lt;= dateadd(MINUTE, +45, CONVERT(time,convert(time,th.hora_inicio,114))) 
   AND th.dia =(SELECT (CASE DATENAME(dw,getdate())
     when 'Lunes' then 'Lunes'
