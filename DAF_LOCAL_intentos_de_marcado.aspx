<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DAF_LOCAL_intentos_de_marcado.aspx.vb" Inherits="DAF_LOCAL_intentos_de_marcado" MasterPageFile="~/mp_daf_local.master" %>
...
<asp:Content ID="Content1" runat="server" contentplaceholderid="ContentPlaceHolder1">
    <form runat ="server" >
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Intentos de Marcado Fuera de Hora</h1>
          </div>
...
where th.ci_doc =@ci  and th.gestion='1-2024' and tp.gestion='1-2024' and a.gestion='1-2024'
ORDER BY hora_inicio, CASE WHEN th.dia = 'Lunes' THEN 1 WHEN th.dia='Martes' THEN 2 WHEN th.dia='Miercoles' THEN 3 WHEN th.dia='Jueves' THEN 4 WHEN th.dia='Viernes' THEN 5  WHEN th.dia='Sabado' THEN 6  END" >
          ...
          <div class="col-md-6">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Fecha y hora de los Intentos</h3>
