              ...
              <div class="card-body">
                  ...
                  <asp:GridView ID="gv_datos" runat="server" CssClass ="table-hover mt-1   " AutoGenerateColumns="False" DataSourceID="sql_ds_clases" Font-Names="Consolas" Font-Size="8pt" GridLines="None">
                      <Columns>
                          ...
                          <asp:BoundField DataField="hra_fin" HeaderText="hHra. de Fin" SortExpression="hra_fin" >
                          </asp:BoundField>
...
where p.gestion ='1-2025'  and sede ='1' and carrera ='carmed'  and p.ci &lt;&gt;'0'
  and  convert(varchar,hr_ingreso,101 ) =@fecha   and (observaciones ='No se Marco la Salida' or observaciones ='No Marco la Salida' or observaciones ='No Asistio a Clases')   and i.gestion ='1-2025'
order by hra_inicio" InsertCommand="INSERT INTO tb_respaldos(respaldo, ci_doc, id_ing_sal, fecha_clase, fecha_registro) VALUES (@respaldo, @cidoc, @iding, @fechaclase, GETDATE())" UpdateCommand="UPDATE tb_ing_sal SET hr_ingreso = @hraingre, hr_salida = @hrasal, observaciones = 'Con Respaldo' WHERE (id_ing_sal = @idingsal)">
                      <InsertParameters>
                      ...
                      <SelectParameters>
                          ...
                          <asp:ControlParameter ControlID="txt_sigla_car" Name="carerra" PropertyName="Text" />
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <%--<input type="text" class="form-control" placeholder="Enter ..." disabled>--%>
                          <asp:Button ID="Button1" runat="server" CssClass =" btn-primary form-control btn-sm  " Text="Subir Respaldo"  Visible="False"  />
                      </div>
                    </div>
                  </div>
...
<asp:ListItem>59</asp:ListItem>
                  ...
                  <asp:Button ID="Button2" runat="server" CssClass ="btn btn-primary mt-1 form-control  " Text="Actualizar Datos de Ingreso y Salida" Visible="False" />
