<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ADM_BLO_horario_x_dia.aspx.vb" Inherits="ADM_BLO_horario_x_dia" MasterPageFile="~/mp_adm_blo.master" %>
...
<asp:Content ID="Content1" runat="server" contentplaceholderid="ContentPlaceHolder1">
    ...
    <asp:Label ID="lbl_cargo"  runat="server" Text=""></asp:Label>
         ...
         <h3>Lista de horario por bloque y dia</h3>
     <div class=" container-fluid ">
    	<div class="row">
                            ...
                            <div class="col-md-12 p-3 mb-2 bg-white text-white ">
                                ...
                                <asp:DropDownList ID="ddl_bloque" CssClass="form-control btn btn-default dropdown-toggle mt-1" runat="server" DataSourceID="sql_ds_bloque" DataTextField="nom_bloque" DataValueField="id_bloque" AppendDataBoundItems="True">
...
where th.gestion ='1-2025' and th.bloque =@bloque and th.dia =@dia and tp.gestion ='1-2025' and ta.gestion='1-2024'
