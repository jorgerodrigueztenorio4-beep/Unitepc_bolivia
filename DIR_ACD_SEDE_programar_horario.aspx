<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DIR_ACD_SEDE_programar_horario.aspx.vb" Inherits="DIR_ACD_SEDE_programar_horario" MasterPageFile="~/mp_dir_academico_sedes.master" %>
    	...
    	<div class="row">
                            ...
                            <div class="col-md-4 p-3 mb-2 bg-white text-white border border-dark rounded ">
                              <div style="background-color:#ffc107" class="text-md-center  rounded text-bold " role="alert">
                                ...
                                <asp:SqlDataSource ID="sql_ds_sede" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" SelectCommand="SELECT * FROM [tb_sedes] where idSede=@id_sd">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="txt_sede" Name="id_sd" PropertyName="Text" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                 ...
                 <asp:TextBox ID="txt_grupos" CssClass ="form-control mt-1" runat="server" Visible="true"></asp:TextBox>
                                ...
                                Programar Clase
                                            ...
                                            <asp:GridView ID="gv_clases" CssClass=" table-hover mt-1 " runat="server" AutoGenerateColumns="False" DataSourceID="sql_ds_clase_no" Font-Size="9pt" DataKeyNames="id_horario">
                                               ...
                                               <asp:SqlDataSource ID="sql_ds_clase_no" runat="server" ConnectionString="<%$ ConnectionStrings:unitepc_boliviaConnectionString %>" SelectCommand="select th.id_horario ,th.dia ,th.tipo_clase,th.hora_inicio,th.hora_fin ,s.NombreSede ,b.nom_bloque , a.nom_aula_lab   
from tb_horario th
join tb_aula a on th.aula = a.id_nomal 
join tb_bloques b on th.bloque = b.id_bloque
join tb_sedes s on th.sede = s.idSede  
where  designado='No' and th.gestion ='1-2024' and th.sede =@sede" DeleteCommand="DELETE FROM tb_horario WHERE (id_horario = @id_horario)">
                                                   <DeleteParameters>
...
WHERE (h.sede = @sede) AND (h.bloque = @bloque) AND (h.dia = @dia) AND (h.aula = @aula) AND (h.hora_inicio &gt;= @hora_in) AND (h.hora_inicio &lt; @horafin)">
                                                   <SelectParameters>
                                                       <asp:ControlParameter ControlID="ddl_sede" Name="sede" PropertyName="SelectedValue" />
                                                       <asp:ControlParameter ControlID="ddl_bloque" Name="bloque" PropertyName="SelectedValue" />
      ...
      <asp:TextBox ID="txt_hrafin" runat="server" Visible="False"></asp:TextBox>
           ...
           <asp:TextBox ID="txt_horas" runat="server" Visible="False"></asp:TextBox>
            ...
            <asp:TextBox ID="txt_ci_us" runat="server" Visible="False"></asp:TextBox>
