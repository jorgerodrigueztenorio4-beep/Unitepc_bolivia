<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DAF_LOCAL_asistencia_dia_hoy.aspx.vb" Inherits="DAF_LOCAL_asistencia_dia_hoy" MasterPageFile="~/mp_daf_local.master" %>
...
where p.gestion ='2-2024' and CONVERT(varchar,hora_registro,103) =CONVERT(varchar,getdate(),103) and sede =@sede and carrera =@carrera  and i.gestion='2-2024'
